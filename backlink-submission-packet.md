...
## Tier 1 — Flagships (submit to ALL directories, incl. Cardboard Connection)

These clear Cardboard Connection's bar (multi-day and/or convention-scale).

### West Side Card Show IV
- **Dates:** Dec 5–6, 2026 (two-day)
...
### HNL Card Fest
- **Dates:** Jul 18–19, 2026 (two-day) — also Jul 10–11, 2027
- **Venue:** Hawaii Convention Center, Room 313 A+B+C, Honolulu, HI
...
## Tier 2 — Recurring series (submit to the calendar directories: TCDb, Card Show Hub, Player One, StackNSlabs)

### Keep It Aloha Card Show
- **Next dates:** Jul 4–5, Aug 2, Sep 5–6, Oct 3–4, Nov 7–8, Dec 4 (2026)
...
### Paradise Card Show
- **Next dates:** Aug 30, Oct 18, Nov 22, Dec 27 (2026)
...
| # | Directory | Submit URL | Account needed? |
|---|---|---|---|
| 1 | **Trading Card Database (TCDb)** | https://www.tcdb.com/CardShows.cfm | Yes (free) — **you must create this** |
| 2 | **Card Show Hub** | https://cardshowhub.com/submit | No |
| 3 | **Player One Collectibles** | https://playeronecollectibles.com/events.php | Yes (free) — **you must create this** |
| 4 | **Sports Collectors Digest** | https://sportscollectorsdigest.com/collecting-101/show-calendar | Check form/contact |
| 5 | **Sports Card Investor** | https://www.sportscardinvestor.com/card-shows/ | Check form/contact |
| 6 | **StackNSlabs Card Show Finder** | https://stacknslabs.com/sns-card-show-finder/ | Check form |
| 7 | **Cardshows.com** | http://www.cardshows.com/ | Check form |
| 8 | **Cardboard Connection** | major-regional convention guide (editorial — email pitch, flagships only) | No (editorial) |
